Pod::Spec.new do |s|
    ...
    s.summary = "An unofficial deployment of ArcGIS Swift Beta (wrappers) to Cocoapods."
    s.description = <<-DESC
    Currently ArcGIS Maps SDK for Swift Beta is available only as SwiftPM package (https://github.com/Esri/arcgis-maps-sdk-swift). This pod makes it possible to consume it via Cocoapods. Works in conjunction with 'CoreArcGIS-Swift-2' pod (same repo). No warranties, just my word of honor.
