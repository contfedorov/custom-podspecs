...
Pod::Spec.new do |s|
    ...
    s.source = { :git => "https://github.com/contfedorov/arcgis-maps-sdk-swift-toolkit.git", :tag => "200.4.0-2" }

    s.dependency "ArcGIS-Swift-2", "200.4.0"
    s.dependency "CoreArcGIS-Swift-2", "200.4.0"
